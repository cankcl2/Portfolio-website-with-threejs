...
const pointlight = new THREE.PointLight(0xfe218b, 7.5, 20);
pointlight.position.set(0, 3, 2);
group.add(pointlight);

const pointlight2 = new THREE.PointLight(0xfed700, 7.5, 20);
...
objloader.load(
    'https://raw.githubusercontent.com//cankcl2/objectsForWebsite/main/assets/planets.obj',
    (object) => {
...
var update = function () {
    ...
    camera.position.y = Math.cos(theta1)+3;
